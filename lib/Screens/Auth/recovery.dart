...
class _RecoveryState extends State<Recovery> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Responsive(
        mobile: _buildRecoveryContent(context, authprovider),
        desktop: Center(
          child: SizedBox(
            width: 500,
            child: _buildRecoveryContent(context, authprovider),
          ),
        ),
      ),
    );
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 24),
              AuthField(controller: recovercontroller, hintText: "Enter Email"),
